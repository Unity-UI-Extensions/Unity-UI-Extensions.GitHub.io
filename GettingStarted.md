...
It is very easy to get started with the Unity UI Extensions project, just add it to your project using the [instructions below](#installation-instructions) or check out the [Downloads page](/Downloads.md) for more details.
...
The recommended way to add the Unity UI Extensions project to your solution is to use the Unity package Manager. Simply use the [Unity Package Manager](/UPMInstallation.md) to reference the project and install it.
