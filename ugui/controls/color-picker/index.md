...
A generated control using the new [Box Slider](/ugui/controls/box-slider/) control and several sliders with helpers.
...
![](/ugui/images/ColorPicker.jpg)

![](/ugui/images/ColorPickerInspector.jpg)
...
![](/ugui/images/ColorPickerPresets.jpg)
...
<video class="demo-video" controls preload="metadata" loop muted playsinline poster="/ugui/images/ColorPickerDemo.jpg" aria-label="Color Picker demo">
  <source src="/ugui/images/ColorPickerDemo.webm" type="video/webm">
</video>
