...
![Gradient 2 Example](/ugui/images/Gradient2Example.jpg)
...
![](/ugui/images/Gradient2Inspector.jpg)
...
<video class="demo-video" controls preload="metadata" loop muted playsinline poster="/ugui/images/Gradient2Demo.jpg" aria-label="Gradient 2 demo">
  <source src="/ugui/images/Gradient2Demo.webm" type="video/webm">
</video>
...
* [Gradient](/ugui/controls/gradient/)
