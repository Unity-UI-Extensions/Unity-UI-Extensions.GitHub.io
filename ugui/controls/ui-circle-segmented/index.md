...
![UICircleSegmented Inspector](/ugui/images/UICircleSegmented/Inspector_preview.png)
![UICircleSegmented Inspector](/ugui/images/UICircleSegmented/Inspector_preview.png)
...
<video class="demo-video" autoplay loop muted playsinline aria-label="UI Circle Segmented demo">
  <source src="/ugui/images/UICircleSegmented/samples_animated.webm" type="video/webm">
</video>

Handle | Handle Inverted

<video class="demo-video" autoplay loop muted playsinline aria-label="UI Circle Segmented demo">
  <source src="/ugui/images/UICircleSegmented/wheel_select.webm" type="video/webm">
</video>

Border Mode

![Border](/ugui/images/UICircleSegmented/border%20example.png)
