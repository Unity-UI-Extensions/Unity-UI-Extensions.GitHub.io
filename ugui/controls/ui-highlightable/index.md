...
![](/ugui/images/UIHighlightableInspector.jpg)
...
<video class="demo-video" controls preload="metadata" loop muted playsinline poster="/ugui/images/UIHighlighterDemo.jpg" aria-label="UI Highlightable demo">
  <source src="/ugui/images/UIHighlighterDemo.webm" type="video/webm">
</video>
...
* [UI Selectable](/ugui/controls/ui-selectable-extension/)
