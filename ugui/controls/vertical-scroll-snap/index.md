...
description: "Paged vertical scroll view that snaps to discrete content pages."
category: "Layout"
permalink: /ugui/controls/vertical-scroll-snap/
has_video: false
tags: [layout, scroll, snap, vertical, pages]
---
...
![Vertical Scroll Snap Inspector](/ugui/images/VSSInspector.jpg)
...
<video class="demo-video" controls preload="metadata" loop muted playsinline poster="/ugui/images/ScrollSnapPerspectiveDemo.jpg" aria-label="Vertical Scroll Snap demo">
  <source src="/ugui/images/ScrollSnapPerspectiveDemo.webm" type="video/webm">
</video>
...
* [ContentScrollSnapHorizontal](/ugui/controls/content-scroll-snap-horizontal/)
* [HorizontalScrollSnap](/ugui/controls/horizontal-scroll-snap/)
* [ScrollSnap](/ugui/controls/scroll-snap/)
