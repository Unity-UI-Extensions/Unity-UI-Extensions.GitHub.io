---
layout: default
title: Release Notes (uGUI) — Unity UI Extensions
description: Release notes and version history for the Unity UI Extensions uGUI package (com.unity.uiextensions).
